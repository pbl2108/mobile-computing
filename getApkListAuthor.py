	...
	if startIdx != -1:
		...
		if startIdx != -1:
			...
			if startIdx != -1:
				...
				print
				print md5
				print 'unzip -p ' + '/proj/ds/encos/apk/' + pathName.rstrip('.apk\r\n') + '.apk' + ' META-INF/*.RSA *.DSA| keytool -printcert | grep MD5'
				print "No signature found for " + pathName.rstrip('.apk\r\n')
